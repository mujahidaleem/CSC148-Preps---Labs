...
def add_n(obj: Union[int, List], n: int) -> Union[int, List]:
    ...
    if isinstance(obj, int):
        ...
        for sublist in obj:
            newList.append(add_n(sublist, n))
        return newList
...
def nested_list_equal(obj1: Union[int, List], obj2: Union[int, List]) -> bool:
    ...
    if type(obj1) != type(obj2):
       ...
       for sublist1, sublist2 in obj1, obj2:
        return nested_list_equal(sublist1, sublist2)
...
def duplicate(obj: Union[int, List]) -> Union[int, List]:
    ...
    for sublist in obj:
        if isinstance(sublist, int):
            newL.extend(duplicate(sublist))
        else:
            newL.append(duplicate(sublist))
    return newL
